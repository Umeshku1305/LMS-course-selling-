      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <header className="flex items-center justify-between p-6 ">
          <div className="flex items-center space-x-2">
            ...
            />
            <h1 className="md:text-2xl text-white-900 font-bold">
              sheryians.com
            </h1>
          </div>
        ...
        <section className="text-center py-20">
          <h1 className="text-4xl font-semibold text-white-500">
            sheryians.com
          </h1>
          ...
          <div className="space-x-4 mt-8">
            ...
            <Link
              to={"https://www.youtube.com/@sheryians"}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="flex flex-col items-center md:items-start">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-2xl text-white-500 font-bold">
                  sheryians.com
                </h1>
              </div>
            ...
            <div className="items-center mt-6 md:mt-0 flex flex-col">
              ...
              <ul className=" space-y-2 text-gray-400">
                <li className="hover:text-white cursor-pointer duration-300">
                  youtube- sheryians_coding_school
                </li>
                <li className="hover:text-white cursor-pointer duration-300">
                  telegram- sheryians coding school
                </li>
                <li className="hover:text-white cursor-pointer duration-300">
                  Github- Umeshku1305
                </li>
